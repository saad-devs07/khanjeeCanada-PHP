...
$fetchfavorite = mysqli_query($connect, 'SELECT * FROM favorites');

while ($favorite = mysqli_fetch_Assoc($fetchfavorite)) {
?>
<tbody class="text-center">
<tr>
  <td><?php echo $favorite['id']; ?></td>
  <td><?php echo $favorite['fmenu_name']; ?></td>
  <td><?php echo $favorite['fmenu_price']; ?></td>
  <td><?php echo $favorite['fmenu_desc']; ?></td>
  <td><?php echo $favorite['fmenu_image']; ?></td>
  <td><?php echo $favorite['date']; ?></td>
  <td>
    <!-- <a class="btn btn-dark btn-sm" href="../coding.php?update_favorite=<?php //echo $favorite['ID']; ?>">Update</a> -->
    <a class="btn btn-outline-danger btn-sm" href="../coding.php?delete_favorite=<?php echo $favorite['id']; ?>">Delete</a>
  </td>
</tr>
</tbody>
